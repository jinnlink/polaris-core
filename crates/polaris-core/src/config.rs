...
pub fn default_registry() -> BTreeMap<&'static str, ParameterSpec> {
    [
        ...
        spec(
            "profile.gate.min_logloss_improvement",
            "0.01",
            ParameterClass::A,
            Some("[0,1]"),
            TuningRoute::Manual,
        ...
        spec(
            "profile.gate.min_improvement_probability",
            "0.95",
            ParameterClass::A,
            Some("[0.5,0.999]"),
            TuningRoute::Manual,
        ...
        spec(
            "profile.gate.min_cross_domain_packs",
            "3",
            ParameterClass::A,
            Some("[2,100]"),
            TuningRoute::Manual,
