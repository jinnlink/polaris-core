...
- [ ] **P17F 桌面生命周期**（`TICKET_P17F_DESKTOP_LIFECYCLE.md`）← **In Progress**；依赖 P17E；后台任务、数据库解析、启动项、密钥、托盘退出、崩溃恢复和日志导出；服务环节：全环节（本地可靠性）
