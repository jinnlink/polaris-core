...
- [ ] **P17G Windows 发布硬化**（`TICKET_P17G_WINDOWS_RELEASE_HARDENING.md`）← **In Progress：本地实现与自动化基线全绿，待生产签名 workflow 和干净 Windows VM transcript**；依赖 P17F；无障碍、性能、视觉回归、NSIS、签名更新和 GitHub Releases CI；服务环节：全环节（公开发布）
