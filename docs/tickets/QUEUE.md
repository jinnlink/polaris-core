...
- [ ] **P17C 知识地图工作区**（`TICKET_P17C_MAP_WORKSPACE.md`）← **In Progress**；依赖 P17B、P16C；当前/预测/全局 Pack 地图、搜索筛选、钻取、证据与大图虚拟化；服务环节：定位模糊
