...
- [x] **P17B 常驻小窗与 Today**（`TICKET_P17B_TRAY_TODAY.md`）← 已实现并通过验收，等待提交；依赖 P17A；托盘、单实例、小窗、Pack 切换、Today 与 2–3 个行动，心流态抑制通知；服务环节：定位模糊 → 针对性补缺
